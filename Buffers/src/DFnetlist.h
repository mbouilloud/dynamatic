...
public:
    ...
    */
     ...
     * been extracted.
     */
    bool addElasticBuffersBB(double Period = 0, double BufferDelay = 0, bool maxThroughput = false, double coverage = 0, int timeout = -1, bool first_MG = false, int max_slots = 0);
